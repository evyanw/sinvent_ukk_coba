                        ...
                        @forelse ($rsetBarangMasuk as $rowbarangmasuk)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data Barang Masuk ini?')"><i class="fa fa-trash"></i></button>
                                    </form>
                                </td>
                            </tr>                            
                        @empty
